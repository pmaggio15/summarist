...
export default function Sidebar({ isLoggedIn, onAuthChange }: SidebarProps) {
      ...
      <aside style={{
        ...
        <nav>
          <div 
            ...
            style={{
              ...
              alignItems: 'center',
              gap: '12px',
              borderLeft: isActive('/for-you') ? '4px solid #2bd97c' : '4px solid transparent',
              color: isActive('/for-you') ? '#032b41' : '#394547',
              fontWeight: '400',
              fontSize: '16px',
              cursor: 'pointer',
              backgroundColor: isActive('/for-you') ? '#f0f0f0' : 'transparent',
          ...
          <div 
            ...
            style={{
              ...
              alignItems: 'center',
              gap: '12px',
              borderLeft: isActive('/library') ? '4px solid #2bd97c' : '4px solid transparent',
              color: isActive('/library') ? '#032b41' : '#394547',
              fontWeight: '400',
              fontSize: '16px',
              cursor: 'pointer',
              backgroundColor: isActive('/library') ? '#f0f0f0' : 'transparent',
              transition: 'background-color 0.2s'
            }}
            onMouseEnter={(e) => {
              if (!isActive('/library')) {
        ...
        <div style={{ position: 'absolute', bottom: '24px', width: '100%' }}>
          <div style={{
            ...
            <svg stroke="currentColor" fill="none" strokeWidth="0" viewBox="0 0 15 15" height="20" width="20">
