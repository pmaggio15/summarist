...
import { setSubscription, getIntendedDestination, clearIntendedDestination } from '@/utils/auth';
...
export default function ChoosePlan() {
  ...
  useEffect(() => {
    ...
    const handleScroll = () => {
      ...
      const stopPosition = pricingSectionRef.current.offsetTop + pricingSectionRef.current.offsetHeight - 10;
