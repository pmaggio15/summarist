...
//   // Use the library context instead of local state
...
//                 fontSize: '16px'
//               }}>
//                 No finished books yet. Books you complete will appear here!
//               </div>
//             ) : (
//               <div style={{
//                 display: 'grid',
...
export default function Library() {
  ...
  // Load placeholder books for finished section
  useEffect(() => {
    fetch('https://us-central1-summaristt.cloudfunctions.net/getBooks?status=recommended')
      .then(res => res.json())
      .then(data => {
        setPlaceholderBooks(data.slice(0, 5)); // Get first 5 books as placeholders
      })
      .catch(error => {
  ...
  // Combine finished books from context with placeholder books
  const displayFinishedBooks = finishedBooks.length > 0 ? finishedBooks : placeholderBooks;

  return (
    <div style={{ display: 'flex', minHeight: '100vh' }}>
      {/* Sidebar - keeping your existing sidebar code */}
      <aside style={{
        width: '200px',
        backgroundColor: '#f7faf9',
        padding: '24px 0',
