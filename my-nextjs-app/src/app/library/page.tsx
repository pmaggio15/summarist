...
//   useEffect(() => {
//     // For now, we'll use recommended books as saved books
//     // You can replace this with actual saved books from your backend
//     fetch('https://us-central1-summaristt.cloudfunctions.net/getBooks?status=recommended')
//       .then(res => res.json())
//       .then(data => {
//         setSavedBooks(data.slice(0, 4)); // Get 4 saved books
//         setFinishedBooks(data.slice(4, 17)); // Get finished books
//         setLoading(false);
//       })
//       .catch(error => {
